...
return array(
    'router' => array(
        'routes' => array(
            ...
            'sucursales' => array( //poner los nombres de nuestro modulo
                'type'    => 'Literal',
                'options' => array(
                    'route'    => '/sucursales',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Sucursales\Controller',
                        'controller'    => 'Index',
                        'action'        => 'index',
                    ),
                ),
    ...
    'controllers' => array(
        'invokables' => array(//Cambiar al nombre del modulo
            'Sucursales\Controller\Index' => 'Sucursales\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
